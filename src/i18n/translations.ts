      ...
      jobs: [
        {
          ...
          achievements: [
            ...
            '開發並整合 HTTP 串流 (Streaming) APIs，將大數據查詢結果直接 Pipe 至用戶端，維持伺服器 $O(1)$ 記憶體開銷並降低首位組傳輸時間 (TTFB)。',
      ...
      jobs: [
        {
          ...
          achievements: [
            ...
            'Performance Optimization: Developed HTTP streaming APIs to pipe large legal datasets directly to clients, maintaining an O(1) server memory footprint and drastically reducing Time to First Byte (TTFB).',
